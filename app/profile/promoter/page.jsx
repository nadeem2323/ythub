  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className="flex justify-between items-center px-20 w-full h-40 bg-default-300/20">
        ...
        <Link href="/profile/upload" className="">
          <Button color='primary'>Upload</Button>
        </Link>
      </div>
      <div className="grid grid-cols-4 max-sm:grid-cols-1 px-12 gap-3">
        <div className="video bg-default-500/20 h-56 rounded-xl"></div>
        <div className="video bg-default-500/20 h-56 rounded-xl"></div>
        <div className="video bg-default-500/20 h-56 rounded-xl"></div>
        <div className="video bg-default-500/20 h-56 rounded-xl"></div>
        <div className="video bg-default-500/20 h-56 rounded-xl"></div>
